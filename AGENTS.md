...
Full-stack framework for deploying AI agents as sovereign on-chain entities. Each agent is an ERC-721 NFT on **Arbitrum Sepolia** with private encrypted data managed through a Phala Cloud TDX TEE oracle. Implements ERC-8004 (Trustless Agent Registry + Reputation) and ERC-7857 (Intelligent Digital Assets with encrypted private metadata).
...
| --------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------- |
| Arbitrum network set                                      | Supported chains live in `NETWORK_CONFIG`; old 0G chain (chainId 16602) removed. Arbitrum Sepolia is the active public deployment target.                                                                                                                                                                                                                                                                                                                                                 | Jun 2026 |
...
| `RPC_URL_ARBITRUM_SEPOLIA` | Yes      | EVM RPC for Arbitrum Sepolia                                                                                                                                         |
...
1. Deploy contracts on Arbitrum Sepolia. Choose either
   `deploy:arbitrumSepolia:remoteOracle` or
   `deploy:arbitrumSepolia:localOracle`.
...
| `EXPLORER_API_KEY`         | No       | Arbiscan API key for source verification |
